    ...
    if last_added_blob:
        ...
        if broker_counts[most_used_broker] > 0:
            ...
            if most_used_broker == "J.B. Hunt":
                ...
                if most_used_broker not in ["J.B. Hunt"]:
                    # Launch the document question-answering pipeline
                    from docquery import document, pipeline
                    p = pipeline('document-question-answering')
                    doc = document.load_document(file_name)
                    questions = [
                    ...
                    print("Answers from document question-answering pipeline:")
